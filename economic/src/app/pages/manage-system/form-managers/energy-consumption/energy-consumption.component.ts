...
export class EnergyConsumptionComponent implements OnInit {
  ...
  list = [];
  listParams = {url: '/manager/v1/EnergyConsumption/findByNameAndYear', method: 'get'};
  formExcelTemplateData: any;
  ngOnInit() {
    const formExcelTemplateData = this.formManagersService.getFormExcelTemplateDownloadData();
    this.formExcelTemplateData = formExcelTemplateData.localtion + formExcelTemplateData.energyConsumption;
    this.getList();
  }
