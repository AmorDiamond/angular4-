...
@Component({
  selector: 'app-advanced-manufacture',
  templateUrl: './advanced-manufacture.component.html',
  styleUrls: ['./advanced-manufacture.component.css']
})
export class AdvancedManufactureComponent implements OnInit {
  ...
  /*获取先进制造数据*/
  getData() {
    this.tradeBoardService.requestByParams({}, 'tradeManufacturingViewUrl').subscribe(res => {
      console.log(res);
