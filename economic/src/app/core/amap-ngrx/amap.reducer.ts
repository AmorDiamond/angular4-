...
import { ADD_MARKER, ADD_MARKER_MID, REMOVE_MARKER, OPEN_INFO, CLOSE_INFO, CLEAR_MARKER, ADD_POLYGON, ADD_SINGLE_POLYGON, ADD_BUILD_MARKER, ADD_INDUSTRY_MAP_POLYGON } from './amap.actions';
